...
local font_family_name = "Iosvmata"
-- local font_family_name = "MesloLGS Nerd Font Mono"
-- local font_family_name = "MesloLGM Nerd Font Mono"
...
-- -- "D://Resources//System//Wallpapers//simple//Santa_Monica.png" -- Background image path
-- -- "D://Resources//System//Wallpapers//lineart//samurai.png" -- Background image path
-- "D://Resources//System//Wallpapers//lineart//handreach.png" -- Background image path
-- -- "D://Resources//System//Wallpapers//lineart//toothless.png" -- Background image path
-- config.window_background_opacity = .98                    -- Background transparency = 0 and opacity = 1
-- config.win32_system_backdrop =
-- 'Tabbed'                                                  -- Creates blurred effects when combined with window_background_opacity -- 'Acrylic', 'Mica', 'Tabbed'
-- -- config.text_background_opacity = 0.3                    -- The image content can have relatively low contrast with respect to the text.
-- config.window_background_image_hsb = hsb_dimmer

hsb_dimmer = {      -- Will implicitly prepend a layer to the background configuration
  brightness = 0.3, -- Darken the background image by reducing it to 1/3rd
  -- brightness = 1.0, -- Darken the background image by reducing it to 1/3rd
...
--       -- File = "D://Resources//System//Wallpapers//lineart//samurai.png" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//lineart//handreach.png" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//lineart//peek.png" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//lineart//gaze.png" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//lineart//fullface.png" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//lineart//halfface.png" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//road.jpg" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//YellowLeaf.jpg" -- Background image path
--       -- -- File = "D://Resources//System//Wallpapers//leather.jpg" -- Background image path
--       -- File = "D://Resources//System//Wallpapers//celestial//blackhole.png" -- Background image path
--     },
--
...
--     -- "Contain" scales the image to fit inside the window without cropping.
--     -- "Cover" scales it to fill the entire background (might crop edges).
--     -- width = 'Contain',
--     height = 'Contain',
--
...
"SteadyBlock" -- Accetable values are SteadyBlock, BlinkingBlock, SteadyUnderline, BlinkingUnderline, SteadyBar, and BlinkingBar
